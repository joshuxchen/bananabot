...
async def help(ctx, command = None):
	if command:
	    com = commands.Bot.get_command(client, str(command))
	    embed = discord.Embed(
		title = f"Command `{com}`",
		color = 0xffe135
	    )
	    ...
	    yoshi = client.get_user(787882180495278081)
	    music = client.get_emoji(804137593297174608)
	    mod = client.get_emoji(804143768306712646)
	    games = client.get_emoji(804145011670384640)
	    images = client.get_emoji(799708210591825960)
	    lennnn = len(client.commands)
	    help = discord.Embed(
		color=0xffe135, 
